        	...
        	<div class="row">
            	<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                	<div id="login">
                            ...
                            <hr>
                           <form name ="join" onsubmit="return validate();" action="<%=request.getContextPath()%>/register.do" method="post">
                                <div class="form-group">
                                	<label>UserID</label>
                                    <input type="text" name="user_id" class=" form-control"  placeholder="Userid" id="id">
                                </div>
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="password" name="u_password" class=" form-control"  placeholder="4~12자리의 영문 대소문자와 숫자로만 입력" id="pw">
                                </div>
                                 <div class="form-group">
                                	<label>Check Password</label>
                                    <input type="password" name="u_password" class=" form-control"  id="checkpw">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="thumb_nail" class=" form-control" value="sample.jpg">
                                </div>
                                 <div class="form-group">
                                	
                                    <input type="hidden" name="user_type" class="form-control" value="<%=request.getParameter("user_type")%>">
                                </div>
                                <div id="pass-info" class="clearfix"></div>
                                <button type="submit" class="btn_full">확인</button>
